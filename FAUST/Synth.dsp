...
envAR(a,r,gate) = (1,_>0:- : _*gate:en.ar(a,r)) ~ _;
...
fmTrig1 = envAR(0, fmAC1+fmRC1, fmRawTrig1);
...
fmTrig2 = envAR(0, fmAC2+fmRC2, fmRawTrig2);
...
fmTrig3 = envAR(0, fmAC3+fmRC3, fmRawTrig3);
fmFreq3 = fmNxtFreq3:ba.sAndH(fmRawTrig3==1);
fm2op3(freq,mMul,dMul,trig,am,rm,ac,rc) =  
    os.osc(
        freq+(  os.osc(freq*mMul)*freq*dMul*envAR(am,rm,trig)  )
    )*envAR(ac,rc, trig);
